...
func TestDocumentLintSourceFinalizesBeforeGenerationPublication(t *testing.T) {
	...
	func() {
		...
		_, _, _ = source.AcquireGeneration(context.Background())
	}()
	if recovered == nil {
